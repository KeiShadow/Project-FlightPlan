...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:PlaceHolder runat="server">
        <div class="form-horizontal">
            ...
            <p class="text-info">
                Došlo k ověření pomocí zprostředkovatele <strong><%: ProviderName %></strong>. Zadejte níže uživatelské jméno
                pro aktuální web a klikněte na tlačítko Přihlásit.
            </p>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="userName"
                        Display="Dynamic" CssClass="text-danger" ErrorMessage="Je vyžadováno uživatelské jméno." />
